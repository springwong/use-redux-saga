...
export function useSagaSimple<Type>(saga: (sages: {type: string, payload: any, useStateVariables: Type | undefined}) => Generator, useStateVariables: Type | undefined = undefined, effect: any = takeLatest): [((payload: any) => void), () => void] {
