...
export function useSagaSimple<Type>(saga: (action: {type: string, payload: any, useStateVariables: Type}) => Generator, useStateVariables: Type, effect: any = takeLatest): [((payload?: any) => void), () => void] {
